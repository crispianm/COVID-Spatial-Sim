...
namespace SR {
	...
	class EventMatrix {		
	private:
          int intMaxDelay,intMaxEvents,intCurrentMatrixTime;
          int intLevelConstraint,intTotalEvents;
	...
	public:
          ...
          void SaveStackToFile(string filename,
                               SR::GridHex& gh,
                               int (*f1)(SR::UNTIMEDEVENT ue));
          void LoadPendingEventsFromFile(
                                         string filename,
                                         SR::GridHex& gh,
                                         SR::UNTIMEDEVENT (*f1)(int));
	};
}
